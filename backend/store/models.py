...
class Order(models.Model):
    ...
    fulfillment_method = models.CharField(max_length=20, default="Pickup")
...
class OrderItem(models.Model):
    ...
    brand = models.ForeignKey(Brand, null=True, blank=True, on_delete=models.SET_NULL, related_name="order_items")
